...
### Ожидание с ограничением времени

Стандартные способы ожидания:
- Относильеный `_for`, ждать промежуток времени;
- Абсолютный `_until`, ждать до наступления даты;

### Часы

Средства работы со временем определены в заголовке `<chrono>`.
